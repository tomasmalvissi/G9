...
namespace PrimG9.Clases
{
    public class ClasePreguntas
    {
        ...
        public string[] pregunta2 = new string[] {"Cuando estudias, ¿Qué estrategias usas?",
                                          "Subrayo las ideas principales",
                                          "Anoto las palabras claves",
                                          "Hago un esquema",
                                          "No tengo una estrategia"};

        public string[] pregunta3 = new string[] {"Cuando estudias una materia, ¿Qué es lo más importante?",
                                         "Aprender con precisión cada detalle de lo leído",
                                         "Comprender las ideas generales",
                                         "Relacionarla con otras materias",
                                         "Hacer un resumen"};

        public string[] pregunta4 = new string[] {"Cuando aprendes algo nuevo;",
        ...
        public string[] pregunta5 = new string[] {"¿Con cuál de las siguientes actividades en clases te motiva más?",
                                         "Debatiendo",
        ...
        public string[] pregunta7 = new string[] {"¿Cómo te proyectas a futuro?",
                                         "Ayudando a que el mundo sea mejor",
                                         "Procurando el bien estar de los otros",
                                         "Resolviendo mis problemas por mi cuenta",
                                         "Trabajando solo"};

        public string[] pregunta8 = new string[] {"Cuando piensas en el trabajo:",
